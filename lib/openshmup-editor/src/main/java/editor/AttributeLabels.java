...
import static edition.EditionData.Keys.*;
...
final public class AttributeLabels {
    ...
    final private static Map<EditionData.Key, String> labelMap = Stream.of(new Object[][]{
        ...
        {Visual.ScrollingImage.speed, "Scrolling speed"},
        {Visual.ScrollingImage.horizontalScrolling, "Horizontal scrolling"},
        ...
        {Spawn.EntitySpawn.id, "Entity ID"},
