...
final public class Level implements EngineSystem {
    ...
    private class LevelDebug {
        ...
        final private RGBAValue levelTimeTextColor = new RGBAValue(1.0f, 1.0f, 1.0f, 1.0f);
        ...
        private static void removeHitboxDebugDisplay(Entity entity) {
        ...
        private void disable() {
            ...
            levelTimeDisplay.getGraphicalLayers().forEachObject(Graphic::remove);
        }
        ...
        public void update() {
            if (debugModeEnabled) {
                ...
                levelTimeDisplay.getGraphicalLayers().forEachObject(graphic -> Engine.getGraphicsManager().addDebugGraphic(graphic));
            }
        }
    }
